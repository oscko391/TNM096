...
def abstract():
    """Added this function to make Python happy per Norvig's suggestion at: http://norvig.com/python-iaq.html - kvlinden, 17dec2012"""
    import inspect
...
#    import utils    Removed this; why should a package import itself? - kvlinden, 12jan2013
    dir = os.path.dirname(__file__) # Also removed the utils.__files__ here for a similar reason. - kvlinden, 21jan2013
